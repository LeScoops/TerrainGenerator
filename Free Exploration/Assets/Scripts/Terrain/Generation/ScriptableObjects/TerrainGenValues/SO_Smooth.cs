...
[CreateAssetMenu(fileName = "so_Smooth", menuName = "Scriptable Objects/Values/Smooth")]
public class SO_Smooth : ScriptableObject
{
    [Header("Smooth Terrain")]
    [Range(1, 10)]
    [SerializeField] int smoothIterations = 1;

    public void Smooth(TerrainData terrainData)
    {
